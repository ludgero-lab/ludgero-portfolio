...
(function (global) {
  ...
  const UI = {
    ...
    "sobre.bio": {
      pt: "Sou Product Designer com <strong>15 anos de experiência</strong> em design e uma trajetória construída, nos últimos 10 anos, entre <strong>produtos digitais</strong>, <strong>EdTech e soluções de T&amp;D</strong>. Combino UX/UI, gamificação, prototipagem e <strong>Design Systems</strong> para transformar problemas — desde regras de negócio até experiências de aprendizagem — em produtos claros, intuitivos e relevantes para quem os utiliza. Venho de uma fase sólida em <strong>direção de arte, motion design e audiovisual</strong>, o que influencia diretamente a forma como penso produto: com atenção à experiência como um todo, à coerência dos sistemas e à qualidade de execução. Mais recentemente, tenho me aproximado de um perfil <strong>designer engineer</strong> — unindo Figma, prototipagem assistida por IA e integrações via MCP para reduzir a distância entre design e desenvolvimento.",
      en: "I'm a Product Designer with <strong>15 years of experience</strong> in design, the last 10 of them spent across <strong>digital products</strong>, <strong>EdTech and L&amp;D solutions</strong>. I combine UX/UI, gamification, prototyping and <strong>Design Systems</strong> to turn problems — from business rules to learning experiences — into products that are clear, intuitive and relevant to the people who use them. I come from a solid background in <strong>art direction, motion design and film</strong>, and that shapes the way I think about product: attentive to the experience as a whole, to the coherence of systems and to the quality of execution. More recently, I have been moving toward a <strong>design engineer</strong> profile — combining Figma, AI-assisted prototyping and MCP integrations to close the gap between design and development."
    },
